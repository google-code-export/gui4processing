...
public class FWindow extends Frame implements GConstants {
	 ...
	 * 
	 */
	public FWinApplet papplet;

	protected String winName;

	public FWinData data;
	 ...
	 */
	public FWindow(PApplet theApplet, String name, int x, int y, int w, int h, boolean noFrame, String mode) {
		super(name);
	 ...
	 */
	public FWindow(PApplet theApplet, String name, int x, int y, PImage image, boolean noFrame, String mode) {
		super(name);
		// The first applet must be the sketchApplet
		if(F4P.sketchApplet == null)
			F4P.sketchApplet = theApplet;
	 ...
	 * @param data
	 */
	public void addData(FWinData data){
		this.data = data;
	...
	public void addDrawHandler(Object obj, String methodName){
		try{
			drawHandlerMethod = obj.getClass().getMethod(methodName, new Class[] {FWinApplet.class, FWinData.class } );
	...
	public void addPreHandler(Object obj, String methodName){
		try{
			preHandlerMethod = obj.getClass().getMethod(methodName, new Class[] {FWinApplet.class, FWinData.class } );
	...
	public void addMouseHandler(Object obj, String methodName){
		try{
			mouseHandlerMethod = obj.getClass().getMethod(methodName, 
					new Class[] {FWinApplet.class, FWinData.class, MouseEvent.class } );
	...
	public void addPostHandler(Object obj, String methodName){
		try{
			postHandlerMethod = obj.getClass().getMethod(methodName, 
					new Class[] {FWinApplet.class, FWinData.class } );
