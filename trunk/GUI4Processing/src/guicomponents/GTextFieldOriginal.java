 ...
 *
 */
public class GTextFieldOriginal extends GComponent {
	 ...
	 */
	public GTextFieldOriginal(PApplet theApplet, String text, int x, int y, int width, int height){
		super(theApplet, x, y);
	...
	private void textFieldCtorCore(String text, int width, int height) {
		...
		setText(text);
		createEventHandler(winApp, "handleTextFieldEvents", new Class[]{ GTextFieldOriginal.class });
